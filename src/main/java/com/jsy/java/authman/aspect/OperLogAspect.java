...
package com.jsy.java.authman.aspect;
...
import com.jsy.java.authman.common.IpUtil;
...
import com.jsy.java.authman.util.DateUtil;
...
public class OperLogAspect {
     ...
     * 操作日志切入点
     */
    @Pointcut("@annotation(com.jsy.java.authman.annotation.OperLog)")
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        operlog.setCreateTime(DateUtil.getStringDateTime(new Date())); // 操作时间
        // 获取方法参数
